...
`func (o *LoginRequest) GetRequestedAt() time.Time`

GetRequestedAt returns the RequestedAt field if non-nil, zero value otherwise.

### GetRequestedAtOk

`func (o *LoginRequest) GetRequestedAtOk() (*time.Time, bool)`
...
`func (o *LoginRequest) SetRequestedAt(v time.Time)`

SetRequestedAt sets RequestedAt field to given value.

### HasRequestedAt

`func (o *LoginRequest) HasRequestedAt() bool`
