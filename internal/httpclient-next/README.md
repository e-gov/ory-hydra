...
| _AdminApi_    | [**ExpireConsentSessions**](docs/AdminApi.md#expireconsentsessions)                                              | **Put** /oauth2/auth/sessions/consent            | # Revokes Consent Sessions of a Subject for a Specific OAuth 2.0 Client                                |
...
| _AdminApi_    | [**RevokeAuthenticationSessionById**](docs/AdminApi.md#revokeauthenticationsessionbyid)                          | **Delete** /oauth2/auth/sessions/login/{id}      | Invalidates an Authentication Session                                                                  |
